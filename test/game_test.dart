...
Game makeGame({int rows, int columns, int numMines}) {
  return Game(
      options: GameOptions(
...
void main() {
  ...
  test("Do not reveal neighbours when there are mines around", () {
    ...
    expect(revealedBoard[0].state, equals(PlaceState.closed));
    expect(revealedBoard[1].state, equals(PlaceState.closed));
    expect(revealedBoard[2].state, equals(PlaceState.opened));
    expect(revealedBoard[3].state, equals(PlaceState.closed));
  });
  ...
  test(
    ...
    expect(revealedBoard[0].state, equals(PlaceState.opened));
    expect(revealedBoard[1].state, equals(PlaceState.opened));
    expect(revealedBoard[2].state, equals(PlaceState.closed));
    expect(revealedBoard[3].state, equals(PlaceState.opened));
    expect(revealedBoard[4].state, equals(PlaceState.opened));
    expect(revealedBoard[5].state, equals(PlaceState.opened));
    expect(revealedBoard[6].state, equals(PlaceState.opened));
    expect(revealedBoard[7].state, equals(PlaceState.opened));
    expect(revealedBoard[8].state, equals(PlaceState.opened));
  });
  ...
  test("Opening a mine triggers all other mines to explode", () {
    ...
    expect(triggeredMineBoard[0].state, equals(PlaceState.closed));
    expect(triggeredMineBoard[1].state, equals(PlaceState.exploded));
    expect(triggeredMineBoard[2].state, equals(PlaceState.exploded));
  });
  ...
  test("Toggling a place marks it as flagged and closed back and forth", () {
    ...
    expect(unflaggedBoard[0].state, equals(PlaceState.closed));
  });
  ...
  test("Places other than closed and flagged cannot be toggled", () {
    ...
    expect(flaggedBoard[0].state, equals(PlaceState.opened));
  });
  ...
  test("A flagged mine should be stated as wrong after defeat", () {
    ...
    expect(triggeredMineBoard[0].state, equals(PlaceState.closed));
    expect(triggeredMineBoard[1].state, equals(PlaceState.flagExploded));
    expect(triggeredMineBoard[2].state, equals(PlaceState.exploded));
  });
  ...
  test("Revealing all safe places means victory", () {
    ...
    expect(game.checkGameState(revealedBoard), GameState.victory);
  });
  ...
  test("Revealing a mine place means defeat", () {
    ...
    expect(revealedBoard[0].state, equals(PlaceState.closed));
    expect(revealedBoard[1].state, equals(PlaceState.exploded));
